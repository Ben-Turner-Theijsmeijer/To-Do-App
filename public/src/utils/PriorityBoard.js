...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const loadTasksFromLocalStorage = () => {
        ...
        tasks.forEach(task => {
            ...
            const targetColumn = document.getElementById(`${task.priority === "Low" ? "low" : task.priority === "Medium" ? "medium" : task.priority === "High" ? "high" : "backlog"}-list`);
    ...
    const createTaskElement = (task) => {
        ...
        taskElement.innerHTML = `
            ...
            <div class="task-details">
                ...
                ${task.category ? `<span class="tag category category-tag">${task.category}</span>` : ""}            </div>
        `;
