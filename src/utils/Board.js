    ...
    const createTaskElement = (task) => {
        ...
        taskElement.innerHTML = `
            ...
            <div class="task-details">
                ${task.category ? `<span class="tag category-tag ${task.category ? `category-${task.category}` : ""}">${task.category}</span>` : ""}
                ${task.priority ? `<span class="tag priority-tag ${task.priority ? `priority-${task.priority}` : ""}">${task.priority}</span>` : ""}
                ${task.recurring ? `<span class="tag recurring-tag ${task.recurring ? `recurring-${task.recurring}` : ""}">${task.recurring}</span>` : ""}
            </div>
        `;
